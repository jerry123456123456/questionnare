...
int main() {
    ...
    while (true) {
        ...
        if (parsingSuccessful) {
            ...
            std::cout << "User Name: " << root["user_name"].asString() << std::endl;
            std::cout << "Table Name: " << root["table_name"].asString() << std::endl;

            const Json::Value& questions = root["questions"];
            for (const auto& question : questions) {
                std::cout << "Question Text: " << question["question_text"].asString() << std::endl;
                std::cout << "Answer: " << question["answer"].asString() << std::endl;
            }
